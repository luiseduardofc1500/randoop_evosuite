...
public class RegressionTest1 {
    ...
    public void test0502() throws Throwable {
        ...
        int int9 = calculadora0.somar(153, 3300);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 53 + "'", int3 == 53);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 0 + "'", int6 == 0);
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 3453 + "'", int9 == 3453);
    }
    ...
    public void test0503() throws Throwable {
        ...
        int int17 = calculadora0.somar((-11), 1623691436);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 53 + "'", int3 == 53);
        org.junit.Assert.assertTrue("'" + double5 + "' != '" + 10.0d + "'", double5 == 10.0d);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 0 + "'", int8 == 0);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 0 + "'", int11 == 0);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 12758818 + "'", int14 == 12758818);
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 1623691425 + "'", int17 == 1623691425);
    }
